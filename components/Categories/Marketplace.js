                ...
                <View style={{width: '100%', marginBottom: 200}}>
                    <View style={styles.stories}>
                        ...
                        <Storyly
                            ...
                            onStoryOpen={() => {}}
                            onStoryClose={() => {}}
                            storyGroupIconBorderColorNotSeen={['#DFDFDF', '#FF163D']}
                        />
                    </View>
                    <TouchableOpacity style={{width: screenWidth, height: screenHeight + screenWidth/1.5}} onPress={() => {navigation.navigate('MarketplaceSecondPage')}}>
                        <Image source={require('../../assets/marketplace/marketplace_ui.png')}  style={{ width: '100%', height: '100%', resizeMode: 'cover'}} />
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
