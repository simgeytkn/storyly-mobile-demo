...
const Ecommerce = ({navigation}) => {
    ...
    return (
        <View>
            <View style={{backgroundColor: '#EFAA7C'}}>
                ...
                <View style={{width: '100%', marginBottom: 200}}>
                    <View style={styles.stories}>
                        ...
                        <Storyly
                            ...
                            onStoryOpen={() => {}}
                            onStoryClose={() => {}}
                            storyGroupIconBorderColorNotSeen={['#477B72', '#477B72']}
                        />
                    </View>
                    <TouchableOpacity onPress={() => {navigation.navigate('EcommerceSecondPage')}}  style={{ width: screenWidth,height:screenHeight+screenWidth/1.5}} >
                        <Image source={require('../../assets/e_commerce/e_commerce_ui.png')}  style={{ width: "100%", height: "100%", resizeMode: 'cover'}} />
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
