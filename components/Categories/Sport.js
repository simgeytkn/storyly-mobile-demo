                ...
                <View style={{width: '100%', marginBottom: 200}}>
                    <View style={styles.stories}>
                        <Text style={{fontSize: 20, paddingTop: 20,fontWeight:'400', fontFamily: 'Nunito-ExtraBold',
                                    color: '#000'}}>
                            Welcome to Sports Sechedule Apps
                        </Text>
                        ...
                        <Storyly
                            ...
                            onStoryOpen={() => {}}
                            onStoryClose={() => {}}
                            storyGroupIconBorderColorNotSeen={['#339974', '#339974']}
                        />
                    </View>
                    <TouchableOpacity onPress={() => {console.log("clicked"); navigation.navigate('SportSecondPage')}}  style={{ width: screenWidth,height:screenHeight+screenWidth*1.75}} >
                        <Image source={require('../../assets/sports_schedule/sports_schedule_ui.png')} style={{resizeMode: 'cover', width:'100%', height:'100%'}} />
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
