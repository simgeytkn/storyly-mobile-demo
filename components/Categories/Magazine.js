                ...
                <View style={{width: '100%', marginBottom: 200}}>
                    <View style={styles.stories}>
                        <Text style={{fontSize: 20, paddingTop: 20,fontWeight:'400', fontFamily: 'Nunito-ExtraBold',
                                    color: '#000'}}>
                             Welcome to Magazines and Newspapers
                        </Text>
                        ...
                        <Storyly
                            ...
                            onStoryOpen={() => {}}
                            onStoryClose={() => {}}
                            storyGroupIconBorderColorNotSeen={['#000', '#000']}
                        />
                    </View>
                    <TouchableOpacity style={{width: screenWidth, height: screenHeight + screenHeight/3}} onPress={() => {navigation.navigate('MagazineSecondPage')}}>
                        <Image source={require('../../assets/magazine_newspaper/magazine_newspaper_ui.png')}  style={{ width: '100%', height:'100%', resizeMode: 'cover'}} />
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
